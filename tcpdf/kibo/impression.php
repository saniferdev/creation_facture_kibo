...
class SANPDF extends TCPDF {
    ...
    public function __construct() {
        ...
        $this->url      = "https://kibo.clic-till.com/wsRest/1_4/wsServerReceipt/getReceipt/";
        $this->key      = "335171tap2b5RsbWlmZ5yaZGZo";
    ...
    public function Header() {
        ...
        $image_file = K_PATH_IMAGES.'kibo_logo.jpg';
        $this->Image($image_file, 10, 20, 45, '', 'JPG', '', 'T', true, 300, 'C', false, false, 0, false, false, false);

        $this->SetFont('helvetica', '', 10);
        $html = '<h1 style="">DEPOT </h1>Lot II I 20 AA Morarano<br>101 Antananarivo<br>Madagascar<br>Tel : 020 225 3099<br>Contact@kibo.mg<br>10103 11 2019 0 11287<br>5003816944';
    ...
    public function Footer() {        
        if($this->isLastPage) {            
            ...
            $this->SetFont('helvetica', '', 10);
            $this->Cell(48, 0, 'BMOI : 00004 00012 03782420101 48', 0, false, 'R', 0, '', 0, false, 'M', 'M');
            $this->Ln();
            $this->Cell(122, 0, 'BFV-SG : 00008 00005 02001011593 39', 0, false, 'R', 0, '', 0, false, 'M', 'M');
            $this->Ln();
            $this->Cell(115, 0, 'BNI : 00005 00007 72698180001 69', 0, false, 'R', 0, '', 0, false, 'M', 'M');
            $this->Ln();
            $this->Cell(117, 0, 'BOA : 00009 07000 22678050005 41', 0, false, 'R', 0, '', 0, false, 'M', 'M');
            $this->Ln(8);
            $this->SetFont('helvetica', '', 10);
            $this->Cell(0, 0, 'Compte MVOLA : 034 02 305 29', 0, false, 'L', 0, '', 0, false, 'M', 'M');
            $this->Ln();
            $this->Cell(0, 0, 'Compte AIRTEL MONEY : 033 68 677 52', 0, false, 'L', 0, '', 0, false, 'M', 'M');
            $this->Ln();
            $this->Cell(60, 0, 'Compte ORANGE : 032 74 048 52', 0, false, 'L', 0, '', 0, false, 'M', 'M');
            $this->Ln();
...
$pdf->setAuthor('WINNY');
$pdf->setTitle('KIBO REIMPRESSION FACTURE');
$pdf->setSubject('REIMPRESSION FACTURE');
$pdf->setKeywords('KIBO, FACTURE, TICKET, REIMPRESSION');

$pdf->setHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.' KIBO TICKET', PDF_HEADER_STRING);
...
$tbl   = <<<EOD
            <table cellpadding="2" cellspacing="0" style="border-collapse: collapse;" nobr="true">
            EOD;
